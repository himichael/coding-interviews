...
| 11 | 旋转数组的最小数字 | [面试题11. 旋转数组的最小数字](https://leetcode-cn.com/problems/xuan-zhuan-shu-zu-de-zui-xiao-shu-zi-lcof/) |[MinNumber In Rotated Array](./11.旋转数组的最小数字/xuan-zhuan-shu-zu-de-zui-xiao-shu-zi-lcof.py) | - | - | - |[MinNumberInRotatedArray.cpp](https://github.com/zhedahht/CodingInterviewChinese2/blob/master/11_MinNumberInRotatedArray/MinNumberInRotatedArray.cpp) | 
...
| 14-1 | 剪绳子-1 | [面试题14. 剪绳子](https://leetcode-cn.com/problems/jian-sheng-zi-lcof/) |[剪绳子](./14- I.剪绳子/jian-sheng-zi-lcof.py) | - | - | - | 作者官方解 | 
| 14-2 | 剪绳子-2 | [面试题14. 剪绳子-2](https://leetcode-cn.com/problems/jian-sheng-zi-ii-lcof/) |[剪绳子-2](./14- II.剪绳子 II/jian-sheng-zi-ii-lcof.py) | - | - | - | 作者官方解 | 
...
| 20 | 表示数值的字符串 | [面试题20. 表示数值的字符串](https://leetcode-cn.com/problems/biao-shi-shu-zhi-de-zi-fu-chuan-lcof/)|[Numeric Strings](./20.表示数值的字符串/biao-shi-shu-zhi-de-zi-fu-chuan-lcof.py) | - | - | - |[NumericStrings.cpp](https://github.com/zhedahht/CodingInterviewChinese2/blob/master/20_NumericStrings/NumericStrings.cppPower.cpp) | 
